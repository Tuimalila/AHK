...
Run, c:\tools\cygwin64\bin\rsync -avc --progress --chown=Administrators --chmod=ugo=rwx rsync://admin@0.0.0.0/ProdCopy/accounts.txt /cygdrive/c/tools/scripts/accounts.txt
Sleep, 2000

Gui, Show, h710 w360, Change Middleware Environment and Users
Gui, Font, cBlack
  ListBox_Text = ;initialize empty variable
  Loop, Read, C:\tools\scripts\accounts.txt
    {
